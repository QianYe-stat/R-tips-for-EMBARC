...
![](../figures/summary_table2.png){width=70% fig-align="center"}
---
...
R-tips-for-EMBARC.Rproj # open this in RStudio
```
+ Analyse the data in efficient and reproducible workflow
```
...
Use **Projects + here + renv** → paths & reproducibility

&#x2705 **table1 + gtsummary** → publication-quality descriptives

✅ **broom + modelsummary** → clean model tables

✅ **Quarto** → code + text + output in one file

✅ Keep scripts modular & outputs organized
